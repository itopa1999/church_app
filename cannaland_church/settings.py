"""
Django settings for cannaland_church project.
...
SECRET_KEY = 'django-insecure-30x#g5&_8yziqc%d0fhq5j1-8wnnmigw5*1x0^fx^(^#dbdysr'
...
EMAIL_HOST_PASSWORD = 'ljvcrvzkkxyiphiy'