    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=1000, null=True, unique=True)),
            ],
            options={
                'ordering': ['name'],
                'indexes': [models.Index(fields=['name'], name='users_depar_name_30ebb2_idx')],
            },
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('exam', models.BooleanField(blank=True, default=True, null=True)),
            ...
            options={
                'ordering': ['-department'],
                'indexes': [models.Index(fields=['-department'], name='users_user_departm_b77304_idx')],
            },
            managers=[
